...
#########################################################################################################################################
#Function: fPreprocessData                                                                                                              #
#The function fPreprocessData has the task to preprocess the data for training CNN. First of all the MRT-image is splittet in Patches.  #
#Every Patch gets a binary class.                                                                                                       #
#                                                                                                                                       #
#Input: Path_markings ---> Path of marking folder                                                                                       #
#       proband: Name of the proband                                                                                                    #
#       model: body region                                                                                                              #
...
#       dimension ---> 2D or 3D (Patch dimension)                                                                                       #
#       ratio_labeling ---> set the ratio of the number of 'Pixel-Artefacts' to the whole number of pixels of one patch                 #
#Output: dPatches ---> Numpy-Array, which contains all Patches.                                                                         #
#        dLabel ---> 1D-Numpy-Array with all corresponding labels                                                                       #
#########################################################################################################################################
...
#Creates the mask for rectangles.                                                                                                       #
#Input: x_coo1, y_coo1, x_coo2, y_coo2 ---> Both coordinates of the rectangle                                                           #
#       layer_mask ---> layer of the 3D-Mask                                                                                            #
#       art_no ---> Artefact-Type: 1: Movement-Artefact, 2: Shim-Artefact, 3: Noise-Artefact                                            #
#Output: layer_mask ---> layer of the 3D-mask with the rectangle                                                                        #
#########################################################################################################################################
...
#########################################################################################################################################
#Function: mask_ellipse                                                                                                                 #
#Creates the mask for ellipse.                                                                                                          #
#Input: x_coo1, y_coo1, x_coo2, y_coo2 ---> Both coordinates of the ellipse                                                             #
#       layer_mask ---> layer of the 3D-Mask                                                                                            #
#       art_no ---> Artefact-Type: 1: Movement-Artefact, 2: Shim-Artefact, 3: Noise-Artefact                                            #
#Output: layer_mask ---> layer of the 3D-mask with the ellipse                                                                          #
#########################################################################################################################################
...
#########################################################################################################################################
#Function: mask_lasso                                                                                                                   #
#Creates the mask for lasso.                                                                                                            #
#Input: p ---> pverts of the Lasso                                                                                                      #
#       layer_mask ---> layer of the 3D-Mask                                                                                            #
#       art_no ---> Artefact-Type: 1: Movement-Artefact, 2: Shim-Artefact, 3: Noise-Artefact                                            #
#Output: layer_mask ---> layer of the 3D-mask with the lasso                                                                            #
#########################################################################################################################################
...
###########################################################################################################################
# Function: create_DICOM_Array                                                                                            #
# This function creates an 3D array with all grey values  (type:integer)                                                  #
# Input: mrt_Folder ----> Path of the MRT-Voxel                                                                           #
#        proband ----> name of chosen proband, example: '01_ab'                                                           #
#        model ----> name of model, example: 't1_tse_tra_Kopf_0002'                                                       #
# Output: voxel_ndarray ----> 3D array with all grey values                                                               #
###########################################################################################################################
...
def create_MASK_Array(Path_mark, proband, model, mrt_height, mrt_width, mrt_depth):
    mask = np.zeros((mrt_height, mrt_width, mrt_depth))
    print("Hi")
    print(mask.dtype)
    loadMark = shelve.open(Path_mark + proband + ".slv")
    print(Path_mark + proband + ".slv")
    #print(loadMark)
    print(model)
    print(loadMark.has_key(model))
