...
def createModel(patchSize, numClasses):
    # SE-ResNet-50 based on Imagenet (224x224 image crops), here used for 128x128 patches
    ...
    x = projection_bottleneck_block(x, (64, 64, 256), stage=2, block=1, se_enabled=True, se_ratio=32)
    x = identity_bottleneck_block(x, (64, 64, 256), stage=2, block=2, se_enabled=True, se_ratio=32)
    x = identity_bottleneck_block(x, (64, 64, 256), stage=2, block=3, se_enabled=True, se_ratio=32)
    x = identity_bottleneck_block(x, (64, 64, 256), stage=2, block=4, se_enabled=True, se_ratio=32)

    # third stage of 6 bottleneck layers, input shape 16x16
    x = projection_bottleneck_block(x, (128, 128, 512), stage=3, block=1, se_enabled=True, se_ratio=64)
    x = identity_bottleneck_block(x, (128, 128, 512), stage=3, block=2, se_enabled=True, se_ratio=64)
    x = identity_bottleneck_block(x, (128, 128, 512), stage=3, block=3, se_enabled=True, se_ratio=64)
    x = identity_bottleneck_block(x, (128, 128, 512), stage=3, block=4, se_enabled=True, se_ratio=64)
    x = identity_bottleneck_block(x, (128, 128, 512), stage=3, block=5, se_enabled=True, se_ratio=64)
    x = identity_bottleneck_block(x, (128, 128, 512), stage=3, block=6, se_enabled=True, se_ratio=64)

    # fourth stage of 3 bottleneck layers, input shape 8x8, without SE blocks due to performance considerations (see original paper)
    x = projection_bottleneck_block(x, (256, 256, 1024), stage=4, block=1, se_enabled=False, se_ratio=128)
    x = identity_bottleneck_block(x, (256, 256, 1024), stage=4, block=2, se_enabled=False, se_ratio=128)
    x = identity_bottleneck_block(x, (256, 256, 1024), stage=4, block=3, se_enabled=False, se_ratio=128)
