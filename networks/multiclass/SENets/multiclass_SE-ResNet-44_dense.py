...
def createModel(patchSize, numClasses):
    ...
    x = projection_bottleneck_block(x, (16, 16, 64), stage=1, block=1, se_enabled=True, se_ratio=4)
    x = identity_bottleneck_block(x, (16, 16, 64), stage=1, block=2, se_enabled=True, se_ratio=4)
