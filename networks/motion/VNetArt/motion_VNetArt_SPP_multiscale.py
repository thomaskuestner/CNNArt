...
def fTrainInner(sOutPath, patchSize, learningRate=0.001, X_train=None, y_train=None, X_test=None, y_test=None,  batchSize=64, iEpochs=299, CV_Patient=0
    ...
    plot_model(cnn_spp_shared, to_file='/no_backup/s1241/MultiScale/model.png',show_shapes='True')
    ...
    callbacks.append(ModelCheckpoint('/no_backup/s1241/MultiScale/checker.hdf5', monitor='val_acc', verbose=0,
...
#    y_train_merge = np.concatenate((y_train, y_train_p2), axis=0)
#    y_test_merge = np.concatenate((y_test, y_test_p2), axis=0)
...
#    dropout_out1 = Dropout(dr_rate)(inp1_SPP)
#    dense_out1 = Dense(units=2,
#                          kernel_initializer='normal',
#                          kernel_regularizer=l2(l2_reg))(dropout_out1)
#    outp1 = Activation('softmax')(dense_out1)
#    
...
#    dropout_out2 = Dropout(dr_rate)(inp2_SPP)
#    dense_out2 = Dense(units=2,
#                          kernel_initializer='normal',
#                          kernel_regularizer=l2(l2_reg))(dropout_out2)
#
#    outp2 = Activation('softmax')(dense_out2)
#    model_shared = Model(inputs=[inp1, inp2], outputs=[outp1,outp2])    
#    return model_shared
...
def fCreateModel_Shared(patchSize, patchSize2, dr_rate=0.0, iPReLU=0, l2_reg=1e-6):
    ...
    inp2_Conv_3 = sharedConv3(inp2_DownConv_2, kernelnumber[2], type=fgetLayerNumConv(), l2_reg=l2_reg)
    inp2_SPP = sharedSPP(inp2_Conv_3, level=3)    
    multi_scale_connect = concatenate([inp1_SPP, inp2_SPP], axis=1)
    
    dropout_out = Dropout(dr_rate)(multi_scale_connect)
    dense_out = Dense(units=2,
                          kernel_initializer='normal',
                          kernel_regularizer=l2(l2_reg))(dropout_out)
