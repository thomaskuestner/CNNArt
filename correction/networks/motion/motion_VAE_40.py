...
class LossLayer(Layer):
    ...
    def vae_loss(self, x_ref, x_decoded, mu, sd):
        ...
        loss_ref2ref = 1600 * losses.binary_crossentropy(x_ref, decoded_ref2ref) + 1e-7
        loss_art2ref = 1600 * losses.binary_crossentropy(x_ref, decoded_art2ref) + 1e-7
...
def fTrainInner(dData, sOutPath, patchSize, epochs, batchSize, lr):
    ...
    weights_file = sOutPath + os.sep + 'vae_weight_ps_{}_bs_{}(l2).h5'.format(patchSize[0], batchSize)
