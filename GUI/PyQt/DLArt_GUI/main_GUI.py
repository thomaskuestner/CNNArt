...
from GUI.PyQt.utilsGUI.Label import *
from GUI.PyQt.DLArt_GUI.dlart_gui import Ui_DLArt_GUI
...
import copy
from GUI.PyQt.DLArt_GUI.PlotCanvas import PlotCanvas
    ...
    def update_multiclass_visualisation(self):
        ...
        if unpatches_slices is not None:
            ...
            if index >= 0 and index < dicom_slices.shape[-1]:
                ...
                #self.multiclassVisualisation_figure.savefig('D:/med_data/MRPhysics/Vortrag_Thomas/Output/' + str(index) + '.png')
    ...
    def plotSegmentationPredictions(self):
        ...
        if unpatched_slices is not None:
            ...
            if index >= 0 and index < dicom_slices.shape[-1]:
                ...
                #self.segmentation_masks_figure.savefig('D:/med_data/MRPhysics/Vortrag_Thomas/Output/' + str(index) + '.png')
    ...
    def plotArtifactMaps(self):
        ...
        if unpatches_slices is not None:
            ...
            if index >= 0 and index < dicom_slices.shape[-1]:
                ...
                self.artifact_map_figure.tight_layout()
                self.artifact_map_figure.savefig('D:/med_data/MRPhysics/Vortrag_Thomas/Output/' + str(index) + '.png')
                self.canvas_artifact_map_figure.draw()
