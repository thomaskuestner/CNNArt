...
data_path = "C:/Users/hansw/Videos/artefacts/MRPhysics/newProtocol/03/dicom_sorted/t1_tse_tra_Kopf_Motion_0003"
id = 0
...
class IndexTracker(object):
    ...
    def onscroll(self, event):
        ...
        if event.button == 'up':
            ...
            self.ind = (self.ind - 1) #% self.slices
        if self.ind >= self.X.shape[1]:
            self.ind = 0
        if self.ind <= -1:
            self.ind = self.X.shape[1]-1
        plt.cla() # not clf
        self.update()
...
PathDicom = "C:/Users/hansw/Videos/artefacts/MRPhysics/newProtocol/03/dicom_sorted/t1_tse_tra_Kopf_Motion_0003"
