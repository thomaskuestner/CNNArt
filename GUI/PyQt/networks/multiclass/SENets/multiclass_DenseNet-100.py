...
def createModel(patchSize, numClasses):
    ...
    # 1. Dense Block
    x, numFilters = dense_block(x, numInputFilters=16, numLayers=32, growthRate_k=growthRate_k, bottleneck_enabled=False)

    # Transition Layer
    x, numFilters = transition_layer(x, numFilters, compressionFactor=compressionFactor)

    # 2. Dense Block
    x, numFilters = dense_block(x, numInputFilters=numFilters, numLayers=32, growthRate_k=growthRate_k, bottleneck_enabled=False)
