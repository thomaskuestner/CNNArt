...
from DLart.Constants_DLart import SGD_OPTIMIZER, ADAM_OPTIMIZER, ADADELTA_OPTIMIZER, ADAGRAD_OPTIMIZER, \
    RMS_PROP_OPTIMIZER
...
def createModel(patchSize, numClasses):
    ...
    # create model
    if usingClassification:
        cnn = Model(inputs=[input_tensor], outputs=[segmentation_output, classification_output],
