...
from configGUI.editlabel import Ui_edit_label
...
class Label_window(QtWidgets.QDialog,Ui_edit_label):
    ...
    def resetLabel(self):
        ...
        with open('configGUI/editlabel.json', 'w') as json_data:
            json_data.write(wFile)
        self.setInit()

    def setPath(self):
        self.pathROI = QtWidgets.QFileDialog.getExistingDirectory(self, "choose the image to view_image", "")
        self.pathline.setText(self.pathROI)
