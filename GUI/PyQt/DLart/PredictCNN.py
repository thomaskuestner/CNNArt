...
from DLart.fSetGPU import fSetGPU
from config.PATH import *

PathIn = TEST_PATH + os.sep + "Prediction_Data/Beckent2_Move_ma_without_2D.h5"
PathOut = PREDICT_RESULT_PATH
sModelPath = CNN_PATH + os.sep + "Kopft1_05_withoutlabel_testma_val_ab_4040_lr_0.001_bs_64.mat"
dData = dict()
patchSize = [40, 40]
