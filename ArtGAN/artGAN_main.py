...
mainpath = 'D:' + os.sep + 'datasets' + os.sep + 'CelebA'
print(mainpath)
...
tf.app.flags.DEFINE_string('checkpoint_dir', mainpath + os.sep + 'srez' + os.sep + 'checkpoint_dir',
                           "Output folder where checkpoints are dumped.")

tf.app.flags.DEFINE_integer('checkpoint_period', 10000,
                            "Number of batches in between checkpoints")

tf.app.flags.DEFINE_string('dataset', mainpath + os.sep + 'dataset',
...
#    # Prepare directories
    ...
    # Create and initialize model
    [gene_minput, gene_moutput, gene_output, gene_var_list, disc_real_output, disc_fake_output, disc_var_list] = \
