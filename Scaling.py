...
def fscaling(X_train, X_test, scpatchSize, iscalefactor):
    ...
    for ifold in range(len(X_train)):
        ...
        for ibatch in range(Batch):
            inter_train0 = np.mgrid[lenTrain // Batch * ibatch:lenTrain // Batch * (ibatch + 1), 0:afterSize,
                           0:afterSize]
            ...
            upedTrain = interpolate.interpn((zaxis_train, xaxis, yaxis),
                                            X_train[0][lenTrain // Batch * ibatch:lenTrain // Batch * (ibatch + 1)],
        ...
        for ibatch in range(Batch):
            ...
            upedTest = interpolate.interpn((zaxis_test, xaxis, yaxis),
                                           X_test[0][lenTest // Batch * ibatch:lenTest // Batch * (ibatch + 1)],
