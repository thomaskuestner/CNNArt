...
class Artefact_Labeling_GUI():
    ...
    def __init__(self):
        ...
        self.list_of_images = ["Move.png", "Rectangle.png", "Ellipse.png", "Lasso.png", "Lupe.png", "3D.png"]
        ...
        self.set_cnn = Button(self.window, text="Settings for CNN", bg="gray56",font=('Arial', 11, 'bold'), command = self.chooseData)
